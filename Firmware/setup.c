...
{
  TRISCbits.RC0 = 0;      //HB
  TRISCbits.RC1 = 1;      //Button
  TRISCbits.RC5 = 0;      //STORAGE_CLK
  TRISCbits.RC6 = 0;      //SHIFT_CLK
  
  TRISBbits.RB2 = 0;      //!OE
  TRISBbits.RB3 = 0;      //!MEM_RES
  TRISBbits.RB4 = 0;      //DATA_OUT
}
...
void heartbeat(void)
{
    ...
    else
    {
        ...
        {
            bHeartState = get_IO(astOutputs,HeartBeat);
            set_IO(astOutputs,HeartBeat,!bHeartState);
        }
    }
}
